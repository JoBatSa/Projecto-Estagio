...
@Component({
  selector: 'app-search-visual-aid-dialog',
  templateUrl: './search-visual-aid-dialog.component.html',
  styleUrls: ['./search-visual-aid-dialog.component.css']
})
export class SearchVisualAidDialogComponent implements OnInit {
